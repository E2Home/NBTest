...
// 给日期控件增加右侧日历按钮图标 林飞 2012-03-20 
$(document).ready(function (e) {
    $("input.formatdate").datepicker({ picker: "<img class='picker' align='middle' src='/Content/themes/Blue/images/icons/s.gif' alt=''/>", showtime: false });
});