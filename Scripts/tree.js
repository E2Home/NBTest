...
(function ($) {
    ...
    $.fn.treeview = function (settings) {
        var dfop =
            {
                ...
                datatype: "json",
                url: false,
                cbiconpath: "/Content/themes/Blue/images/icons/",
                icons: ["checkbox_0.gif", "checkbox_1.gif", "checkbox_2.gif"],
                emptyiconpath: "/Content/themes/Blue/images/icons/s.gif",
        ...
        function reflash(itemId) {
            // 兼容Guid形式的Id 林飞修改 2012-02-25
            //var nid = itemId.replace(/[^\w-]/gi, "_");
            var nid = itemId.replace(/[-]/gi, "_");
            var node = $("#" + id + "_" + nid);
            if (node.length > 0) {
        ...
        function selectedNode(item) {
            ...
            dfop.citem = item;
            var cid = item.id.replace(/[^\w]/gi, "_");
            $("#" + id + "_" + cid).addClass("bbit-tree-selected");
        }
        ...
        me[0].t = {
            ...
            clickNode: function (itemId) {
                if (itemId != undefined) {
                    clickNodeById(itemId);
                }
            }
        };
        return me;
    ...
    //点击指定Id的节点
    $.fn.clickTreeNode = function (itemId) {
        if (this[0].t) {
            return this[0].t.clickNode(itemId);
        }
    };
})(jQuery);